...
public class AbandonedLumberjackHouseStructure extends StructureFeature<JigsawConfiguration> {

    public AbandonedLumberjackHouseStructure(Codec<JigsawConfiguration> codec) {
        super(codec, AbandonedLumberjackHouseStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!AbandonedLumberjackHouseStructure.isFeatureChunk(context)) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            UnbelievableMod.LOGGER.log(Level.DEBUG, "Abandoned Lumberjack House at " + blockpos);
        }
