...
public class MountainFortressStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MountainFortressStructure(Codec<JigsawConfiguration> codec) {
        super(codec, MountainFortressStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(
                () -> context.registryAccess().ownedRegistryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                        .get(new ResourceLocation(UnbelievableMod.MODID, "mountain_fortress/start_pool")),
                10
        );
